      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="text-2xl font-bold font-serif flex items-center mb-4">
            ...
            <p className="text-gray-500 max-w-md mb-6">
              Rediscover your natural balance with our proprietary herbal inhalers.
              Sustainably sourced ingredients, handcrafted for your well-being.
            </p>
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="px-4 py-2 bg-white rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-500/50 transition-all"
              />
              <button 
                type="submit"
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Inhale/Exhale. All rights reserved.</p>
